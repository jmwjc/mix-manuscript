...
\begin{table}[!htp]
\centering
\caption{Inf-sup condition and constraint ratio for various mixed formulations} \label{tb:inf_sup_condition}
\begin{tabular}{ccccc}
\hline
\multirow{2}{*}{\scriptsize Formulation} & \multicolumn{2}{c}{\scriptsize Inf-sup condition} & {\scriptsize Constraint Ratio} & {\scriptsize Constraint Ratio} \\
& {\tiny Numerical prediction} & {\tiny Analytical proof} & {\scriptsize $r \ge n_d$} & {\scriptsize $r = r_{opt}$} \\
\hline
\parbox{0.2\textwidth}{\centering\includegraphics[width=0.1\textwidth]{mix_T3P1.png}\\[-1.5ex]{\tiny T3P1($r=1$)}\\[1ex]}
& $\times$ & $\times$ & $\times$ & $\times$ \\
\parbox{0.2\textwidth}{\centering\includegraphics[width=0.1\textwidth]{mix_Q4P1.png}\\[-1.5ex]{\tiny Q4P1($r=2$)}\\[1ex]}
& $\times$ & $\times$ & \checkmark & $\times$ \\
\parbox{0.2\textwidth}{\centering\includegraphics[width=0.1\textwidth]{mix_Q8P3.png}\\[-1.5ex]{\tiny Q8P3($r=2$)}\\[1ex]}
& $\times$ & $\times$ & \checkmark & $\times$ \\
\parbox{0.2\textwidth}{\centering\includegraphics[width=0.1\textwidth]{mix_Q8P1.png}\\[-1.5ex]{\tiny Q8P1($r=6$)}\\[1ex]}
& \checkmark & \checkmark & \checkmark & \checkmark \\
\parbox{0.2\textwidth}{\centering\includegraphics[width=0.1\textwidth]{mix_Q9P3.png}\\[-1.5ex]{\tiny Q9P3($r=\frac{8}{3}$)}\\[1ex]}
& \checkmark & \checkmark & \checkmark & \checkmark \\
\parbox{0.2\textwidth}{\centering\includegraphics[width=0.1\textwidth]{mini.png}\\[-1.5ex]{\tiny MINI($r=6$)}\\[1ex]}
& \checkmark & \checkmark & \checkmark & \checkmark \\
\parbox{0.2\textwidth}{\centering\includegraphics[width=0.1\textwidth]{TaylorHood.png}\\[-1.5ex]{\tiny Taylor--Hood($r=8$)}\\[1ex]}
& \checkmark & \checkmark & \checkmark & \checkmark \\
\parbox{0.2\textwidth}{\centering\includegraphics[width=0.1\textwidth]{mix_T6C3.png}\\[-1.5ex]{\tiny T6C3($r=8$)}\\[1ex]}
& \checkmark & \checkmark &  & \checkmark \\
% \parbox{0.25\textwidth}{\centering\includegraphics[width=0.1\textwidth]{CrouzeixRaviart.png}\\[-1.5ex]{\tiny Crouzeix--Raviart($r=4$)}\\[1ex]}
% & \checkmark & \checkmark &  & \checkmark \\
\multicolumn{5}{l}{
    \includegraphics[width=5pt]{legend_u.png}
    \scriptsize :Displacement node
    \quad
    % \includegraphics[width=5pt]{legend_p2.png}
    % \scriptsize :Discontinuous pressure node
    % \quad
    \includegraphics[width=5pt]{legend_p.png}
    \scriptsize :Pressure node
}\\
\hline
\end{tabular}
\end{table}
