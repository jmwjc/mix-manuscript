...
\raisebox{-0.8\height}{\includegraphics[width=0.48\textwidth]{cantilever_tri_Hdev_4.png}}
& \raisebox{-0.8\height}{\includegraphics[width=0.48\textwidth]{cantilever_tri_L2_p_4.png}} \\
\raisebox{-0.85\height}{\includegraphics[width=0.48\textwidth]{cantilever_tri_Hdev_8.png}}
& \raisebox{-0.85\height}{\includegraphics[width=0.48\textwidth]{cantilever_tri_L2_p_8.png}} \\
\raisebox{-0.85\height}{\includegraphics[width=0.48\textwidth]{cantilever_tri_Hdev_16.png}}
& \raisebox{-0.85\height}{\includegraphics[width=0.48\textwidth]{cantilever_tri_L2_p_16.png}} \\
\raisebox{-0.85\height}{\includegraphics[width=0.48\textwidth]{cantilever_tri_Hdev_32.png}}
 & \raisebox{-0.85\height}{\includegraphics[width=0.48\textwidth]{cantilever_tri_L2_p_32.png}} \\
\end{tabular}
\end{subcaptiongroup}
...
\begin{tabular}{c@{\hspace{0pt}}c}
$\Vert \boldsymbol{u} - \boldsymbol{u}_h \Vert_V$ & $\Vert p - p_h \Vert_Q$ \\
\raisebox{-0.8\height}{\includegraphics[width=0.48\textwidth]{cantilever_Hdev_4.png}}
& \raisebox{-0.8\height}{\includegraphics[width=0.48\textwidth]{cantilever_L2_p_4.png}} \\
\raisebox{-0.85\height}{\includegraphics[width=0.48\textwidth]{cantilever_Hdev_8.png}}
& \raisebox{-0.85\height}{\includegraphics[width=0.48\textwidth]{cantilever_L2_p_8.png}} \\
\raisebox{-0.85\height}{\includegraphics[width=0.48\textwidth]{cantilever_Hdev_16.png}}
& \raisebox{-0.85\height}{\includegraphics[width=0.48\textwidth]{cantilever_L2_p_16.png}} \\
\raisebox{-0.85\height}{\includegraphics[width=0.48\textwidth]{cantilever_Hdev_32.png}}
 & \raisebox{-0.85\height}{\includegraphics[width=0.48\textwidth]{cantilever_L2_p_32.png}} \\
\end{tabular}
\end{subcaptiongroup}
...
\begin{tabular}{c@{\hspace{0pt}}c}
$\Vert \boldsymbol{u} - \boldsymbol{u}_h \Vert_V$ & $\Vert p - p_h \Vert_Q$ \\
\raisebox{-0.8\height}{\includegraphics[width=0.48\textwidth]{cantilever_tri_irregular_Hdev.png}}
& \raisebox{-0.8\height}{\includegraphics[width=0.48\textwidth]{cantilever_tri_irregular_L2_p.png}} \\
\raisebox{-0.85\height}{\includegraphics[width=0.48\textwidth]{cantilever_quad_irregular_Hdev.png}}
& \raisebox{-0.85\height}{\includegraphics[width=0.48\textwidth]{cantilever_quad_irregularL2_p.png}} 
\end{tabular}
\end{subcaptiongroup}
\caption{Strain and pressure errors vs. $n_p$ for cantilever beam problem with non--uniform discretizations}\label{fg:cantilever_ns_irregular}
\end{figure}
