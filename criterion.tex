...
\end{align}
Additionally, the \ref{error} lists the displacement and pressure error estimators for the mixed-formulations.
This indicates how the inf-sup value $\beta$ affects the solution accuracy.
