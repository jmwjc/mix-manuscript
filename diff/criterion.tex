...
The \DIFaddbegin \ref{error} \DIFadd{lists the displacement and pressure error estimators for mixed--formulations.
These estimators imply how the inf--sup value $\beta$ affects solution's accuracy.
The }\DIFaddend norms $\|\bullet\|_V$ and $\|\bullet\|_Q$ can be flexibly defined by:
\begin{align}
\label{norm_V}
...
As we can see in Eqs. \eqref{estimator} and \eqref{beta_s}, $\beta_s \ge 0$, the condition that $\beta_s$ being equal to $0$ or not determines whether the formulation can satisfy the inf-sup condition. If $\beta_s > 0$, as the mesh refines, the second term on the right-hand side of Eq. \eqref{estimator} will sharply reduce and can be ignored. In contrast, if $\beta_s = 0$, the second term will dominate, and the evaluation of $\beta$ will be dependent to $h$.
...
%DIF <  Table \ref{tb:inf_sup_condition} lists the effectiveness of the traditional constraint ratio and the proposed optimal constraint ratio for traditional mixed formulation schemes, comparing the constraint ratios with the fulfillment of the inf-sup condition using analytical proof and numerical prediction. The table reveals that the traditional constraint ratio $r \ge n_d$ is not sufficient to guarantee the inf-sup condition, especially for low-order mixed formulations like T3P1 and Q4P1. The proposed optimal constraint ratio $r_{opt} \ge \frac{n_d \times n_u}{n_s}$ is more effective in ensuring the inf-sup condition,
%DIF <  since the corresponding results is consistent with numerical prediction or analytical proof of inf--sup condition.
\DIFaddbegin \DIFadd{Table \ref{tb:inf_sup_condition} lists the effectiveness of the traditional constraint ratio and the proposed optimal constraint ratio for traditional mixed formulation schemes, comparing the constraint ratios with the fulfillment of the inf-sup condition using analytical proof and numerical prediction. The table reveals that the traditional constraint ratio $r \ge n_d$ is not sufficient to guarantee the inf-sup condition, especially for Q4P1 and Q8P3. The proposed optimal constraint ratio $r_{opt} \ge \frac{n_d \times n_u}{n_s}$ is more effective in ensuring the inf-sup condition,
since the corresponding results is consistent with numerical prediction or analytical proof of inf--sup condition.
}\DIFaddend 

%DIF <  \begin{table}[!htb]
%DIF <  \centering
%DIF <  \caption{Constraint ratio and inf-sup condition for various mixed formulations} \label{tb:inf_sup_condition}
%DIF <  \begin{tabular}{ccccc}
%DIF <  \hline
%DIF <  \multirow{2}{*}{\scriptsize Formulation} & {\scriptsize Constraint Ratio} & \multicolumn{2}{c}{\scriptsize Inf-sup condition} & {\scriptsize Constraint Ratio} \\
%DIF <  & {\scriptsize $r \ge n_d$} & {\tiny Numerical prediction} & {\tiny Analytical proof} & {\scriptsize $r = r_{opt}$} \\
%DIF <  \hline
%DIF <  \parbox{0.2\textwidth}{\centering\includegraphics[width=0.1\textwidth]{png/mix_T3P1.png}\\[-1.5ex]{\tiny T3P1($r=1$)}\\[1ex]}
%DIF <  & $\times$ & $\times$ & $\times$ & $\times$ \\
%DIF <  \parbox{0.2\textwidth}{\centering\includegraphics[width=0.1\textwidth]{png/mix_Q4P1.png}\\[-1.5ex]{\tiny Q4P1($r=2$)}\\[1ex]}
%DIF <  & \checkmark & $\times$ & $\times$ & $\times$ \\
%DIF <  \parbox{0.2\textwidth}{\centering\includegraphics[width=0.1\textwidth]{png/mix_Q8P3.png}\\[-1.5ex]{\tiny Q8P3($r=2$)}\\[1ex]}
%DIF <  & \checkmark & $\times$ & $\times$ & $\times$ \\
%DIF <  \parbox{0.2\textwidth}{\centering\includegraphics[width=0.1\textwidth]{png/mix_Q8P1.png}\\[-1.5ex]{\tiny Q8P1($r=6$)}\\[1ex]}
%DIF <  & \checkmark & \checkmark & \checkmark & \checkmark \\
%DIF <  \parbox{0.2\textwidth}{\centering\includegraphics[width=0.1\textwidth]{png/mix_Q9P3.png}\\[-1.5ex]{\tiny Q9P3($r=\frac{8}{3}$)}\\[1ex]}
%DIF <  & \checkmark & \checkmark & \checkmark & \checkmark \\
%DIF <  \parbox{0.2\textwidth}{\centering\includegraphics[width=0.1\textwidth]{png/mini.png}\\[-1.5ex]{\tiny MINI($r=\frac{8}{3}$)}\\[1ex]}
%DIF <  & \checkmark & \checkmark & \checkmark & \checkmark \\
%DIF <  \parbox{0.2\textwidth}{\centering\includegraphics[width=0.1\textwidth]{png/TaylorHood.png}\\[-1.5ex]{\tiny Taylor--Hood($r=8$)}\\[1ex]}
%DIF <  & \checkmark & \checkmark & \checkmark & \checkmark \\
%DIF <  \parbox{0.2\textwidth}{\centering\includegraphics[width=0.1\textwidth]{png/mix_T6C3.png}\\[-1.5ex]{\tiny T6C3($r=\frac{8}{3}$)}\\[1ex]}
%DIF <  & \checkmark & \checkmark &  & \checkmark \\

\DIFaddbegin \begin{table}[!htp]
\centering
\caption{\DIFaddFL{Inf-sup condition and constraint ratio for various mixed formulations}} \label{tb:inf_sup_condition}
\begin{tabular}{ccccc}
\hline
\multirow{2}{*}{\scriptsize Formulation} & \multicolumn{2}{c}{\scriptsize \DIFaddFL{Inf-sup condition}} & {\scriptsize \DIFaddFL{Constraint Ratio}} & {\scriptsize \DIFaddFL{Constraint Ratio}} \\
& {\tiny \DIFaddFL{Numerical prediction}} & {\tiny \DIFaddFL{Analytical proof}} & {\scriptsize \DIFaddFL{$r \ge n_d$}} & {\scriptsize \DIFaddFL{$r = r_{opt}$}} \\
\hline
\parbox{0.2\textwidth}{\centering\includegraphics[width=0.1\textwidth]{png/mix_T3P1.png}\\[-1.5ex]{\tiny T3P1($r=1$)}\\[1ex]}
& \DIFaddFL{$\times$ }& \DIFaddFL{$\times$ }& \DIFaddFL{$\times$ }& \DIFaddFL{$\times$ }\\
\parbox{0.2\textwidth}{\centering\includegraphics[width=0.1\textwidth]{png/mix_Q4P1.png}\\[-1.5ex]{\tiny Q4P1($r=2$)}\\[1ex]}
& \DIFaddFL{$\times$ }& \DIFaddFL{$\times$ }& \checkmark & \DIFaddFL{$\times$ }\\
...
& \checkmark & \checkmark & \checkmark & \checkmark \\
\parbox{0.2\textwidth}{\centering\includegraphics[width=0.1\textwidth]{png/mini.png}\\[-1.5ex]{\tiny MINI($r=6$)}\\[1ex]}
& \checkmark & \checkmark & \checkmark & \checkmark \\
\parbox{0.2\textwidth}{\centering\includegraphics[width=0.1\textwidth]{png/TaylorHood.png}\\[-1.5ex]{\tiny Taylor--Hood($r=8$)}\\[1ex]}
& \checkmark & \checkmark & \checkmark & \checkmark \\
\parbox{0.2\textwidth}{\centering\includegraphics[width=0.1\textwidth]{png/mix_T6C3.png}\\[-1.5ex]{\tiny T6C3($r=8$)}\\[1ex]}
...
%DIF <  \hline
%DIF <  \multicolumn{5}{c}{
%DIF <      \includegraphics[width=5pt]{png/legend_u.png}
%DIF <      \scriptsize :Displacement node
%DIF <      \quad
%DIF <      \includegraphics[width=5pt]{png/legend_p2.png}
%DIF <      \scriptsize :Discontinuous pressure node
%DIF <      \quad
%DIF <      \includegraphics[width=5pt]{png/legend_p.png}
%DIF <      \scriptsize :Continuous pressure node
%DIF <  }\\
%DIF <  \hline
%DIF <  \end{tabular}
%DIF <  \end{table}
...
\multicolumn{5}{l}{
    ...
    \scriptsize \DIFaddFL{:Displacement node
    \quad
    %DIF >  \includegraphics[width=5pt]{png/legend_p2.png}
    %DIF >  \scriptsize :Discontinuous pressure node
    %DIF >  \quad
    }\includegraphics[width=5pt]{png/legend_p.png}
    \scriptsize \DIFaddFL{:Pressure node
}}\\
\hline
\end{tabular}
\end{table}
