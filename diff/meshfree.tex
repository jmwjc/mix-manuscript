...
\DIFaddbegin \DIFadd{Table \ref{tab_gauss} lists the integration schemes used in this work for mixed-formulations.
...
The detailed locations and weights of the Gauss points can be found in Ref. \mbox{%DIFAUXCMD
\cite{bathe1996}}\hskip0pt%DIFAUXCMD
.
...
\begin{table}[H]
\centering
\caption{\DIFaddFL{Integration schemes for the mixed FE--meshfree formulation}}
\label{tab_gauss}
\begin{tabular}{cccc}
\toprule
