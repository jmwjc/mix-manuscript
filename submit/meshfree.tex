...
Tet4--RK & Hex8--RK \\
\raisebox{-0.3\height}{\includegraphics[width=12pt]{legend_u.png}} :Displacement node &
\raisebox{-0.3\height}{\includegraphics[width=12pt]{legend_p.png}} :Pressure node
\end{tabular}
